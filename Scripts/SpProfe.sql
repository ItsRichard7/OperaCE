...
-- Verificar que no haya otra solicitud del laboratorio (Vista Reservaci�n Laboratorios)
...
-- Insertar una nueva solicitud de laboratorio (Vista Reservaci�n Laboratorios)
